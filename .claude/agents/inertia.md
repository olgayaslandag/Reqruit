...
- **Types (`resources/js/types`):** Bileşenlerin arası sözleşmeleri tanımlayan ilgili tipler.
...
- **Bileşen Sözleşmesi:** Props, Events ve State tanımları açık ve tutarlı olmalıdır.
