...
export default function Edit({ candidate }) {
    ...
    const handleSubmit = (e) => {
        ...
        put(`/admin/candidates/${candidate.id}`, {
            preserveScroll: true,
            onSuccess: () => showSuccess('Kalifiye eleman başarıyla güncellendi.'),
        });
    };
    ...
    return (
        <AuthenticatedLayout
            pageHeader={{
                title: 'Kalifiye Eleman Düzenle',
                breadcrumbs: [
                    { label: 'Ana Sayfa', url: route('dashboard') },
                    { label: 'Kalifiye Elemanlar', url: route('admin.candidates.index') },
                    { label: 'Düzenle', url: route('admin.candidates.edit', candidate.id) },
                ],
            }}
        >
            <Head title="Kalifiye Eleman Düzenle" />
